  ...
  >
    ...
    >
      ...
      <a href="{{ url('/admin') }}" class="lg:hidden flex items-center space-x-2">
        <img class="w-12 dark:hidden" src="{{ asset('tailadmin/images/logo/logo_kotaSemarang.png') }}" alt="Logo" />
        <img class="hidden dark:block w-12" src="{{ asset('tailadmin/images/logo/logo_kotaSemarang.png') }}" alt="Logo" />
    ...
    >
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full ring-2 ring-orange-200 dark:ring-orange-500/40">
            <img src="{{ asset('tailadmin/images/user/user-default.png') }}" alt="User" />
          </span>

          <span class="text-theme-sm mr-1 block font-semibold leading-tight">
            {{ $user->name ?? 'User' }}
          ...
          <svg
            ...
            class="stroke-gray-500 transition-transform duration-200 dark:stroke-gray-300"
            width="18"
            height="20"
            viewBox="0 0 18 20"
            fill="none"
        ...
        <div
          x-show="dropdownOpen"
          class="shadow-theme-lg dark:bg-gray-dark absolute right-0 mt-[17px] flex w-[280px] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800"
        >
          <div class="space-y-1 bg-white p-3 dark:bg-gray-900">
            <form method="POST" action="{{ route('logout') }}">
              @csrf
              <button
                type="submit"
                class="group mt-1 flex w-full items-center gap-3 rounded-lg bg-red-50 px-3 py-2 text-sm font-semibold text-red-600 transition hover:bg-red-100 dark:bg-red-900/20 dark:text-red-400 dark:hover:bg-red-900/30"
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M16 13v-2H7V8l-5 4 5 4v-3h9Zm2-11H6c-1.1 0-2 .9-2 2v5h2V4h12v16H6v-5H4v5c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2Z" />
                </svg>
                Sign out
              </button>
            </form>
