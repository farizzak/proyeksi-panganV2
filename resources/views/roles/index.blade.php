          ...
          <form id="myform" method="POST" action="{{ route('roles.store') }}" class="space-y-6">
            ...
            <div class="flex justify-end gap-3 pt-2">
              ...
              <button id="submitRoleBtn" type="submit" 
                class="btn-brand-stable bg-orange-600 hover:bg-orange-700 dark:bg-orange-600 dark:hover:bg-orange-700 px-4 py-2 text-sm font-medium text-white rounded-lg flex items-center gap-1">
                Submit
